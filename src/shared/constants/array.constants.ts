...
export const LandingPageSlugs = [
  'landing_main_banner_main_title',
  'landing_main_banner_first_title',
  'landing_main_banner_second_title',
  ...
  'landing_achievement_list_first_title',
  'landing_achievement_list_first_title_user',
  'landing_achievement_list_second_title',
  'landing_achievement_list_second_title_user',
  'landing_achievement_list_third_title',
  'landing_achievement_list_third_title_user',
  'landing_achievement_list_fourth_title',
  'landing_achievement_list_fourth_title_user',
  'landing_most_popular_course_list_first_card_title',
  'landing_most_popular_course_list_first_card_img',
  'landing_most_popular_course_list_first_card_desc',
  'landing_most_popular_course_list_second_card_title',
  'landing_most_popular_course_list_second_card_img',
  'landing_most_popular_course_list_second_card_desc',
  'landing_most_popular_course_list_third_card_title',
  'landing_most_popular_course_list_third_card_img',
  'landing_most_popular_course_list_third_card_desc',
  'landing_programme_main_title',
  'landing_programme_main_desc',
  'landing_programme_first_card_title',
  'landing_programme_first_card_desc',
  'landing_programme_second_card_title',
  'landing_programme_second_card_desc',
  'landing_programme_third_card_title',
  'landing_programme_third_card_desc',
  'landing_programme_fourth_card_title',
  'landing_programme_fourth_card_desc',
  'landing_contact_us_first_card_title',
  'landing_contact_us_first_card_desc',
  'landing_contact_us_second_card_title',
  'landing_contact_us_second_card_desc',
  'landing_contact_us_third_card_title',
  'landing_contact_us_third_card_desc',
  'landing_contact_us_fourth_card_title',
  'landing_contact_us_fourth_card_desc',
  'landing_contact_us_fifth_card_title',
  'landing_contact_us_fifth_card_desc',
];

export const LandingSRTSTPageSlugs = [
  'landing_srtst_main_banner_image_url',
  'landing_about_us_srtst_title',
  'landing_about_us_srtst_image_url',
  'landing_about_us_srtst_desc',
  'landing_benefit_srtst_main_title',
  'landing_benefit_srtst_first_sub_title',
  'landing_benefit_srtst_second_sub_title',
  'landing_benefit_srtst_card_first_title',
  'landing_benefit_srtst_card_first_desc',
  'landing_benefit_srtst_card_second_title',
  'landing_benefit_srtst_card_second_desc',
  'landing_benefit_srtst_card_third_title',
  'landing_benefit_srtst_card_third_desc',
  'landing_benefit_srtst_card_fourth_title',
  'landing_benefit_srtst_card_fourth_desc',
  'landing_benefit_srtst_image',
  'landing_syllabus_srtst_title',
  'landing_syllabus_srtst_desc',
  'landing_success_srtst_title',
  'landing_success_srtst_first_subtitle',
  'landing_success_srtst_second_subtitle',
  'landing_success_srtst_desc',
  'landing_success_srtst_image',
  'landing_contact_us_first_card_title',
  'landing_contact_us_first_card_desc',
  'landing_contact_us_second_card_title',
  'landing_contact_us_second_card_desc',
...
export const LandingAboutUsSrtstSectionDataSlugs = [
  'landing_about_us_srtst_title',
  'landing_about_us_srtst_image_url',
  'landing_about_us_srtst_desc'
];

export const LandingBenefitSrtstSectionDataSlugs = [
  'landing_benefit_srtst_image',
  'landing_benefit_srtst_main_title',
  'landing_benefit_srtst_first_sub_title',
  'landing_benefit_srtst_second_sub_title',
...
export const LandingSyllabusSrtstSectionDataSlugs = [
  'landing_syllabus_srtst_title',
  'landing_syllabus_srtst_desc'
];

export const LandingSuccessSrtstSectionDataSlugs = [
  'landing_success_srtst_title',
  'landing_success_srtst_first_subtitle',
  'landing_success_srtst_second_subtitle',
  'landing_success_srtst_desc',
...
export const LandingAchivementSectionDataSlugs = [
  'landing_achievement_list_first_title',
  'landing_achievement_list_first_title_user',
  'landing_achievement_list_second_title',
  'landing_achievement_list_second_title_user',
...
export const LandingMostPopularCourseSectionDataSlugs = [
  'landing_most_popular_course_list_first_card_title',
  'landing_most_popular_course_list_first_card_img',
  'landing_most_popular_course_list_first_card_desc',
  'landing_most_popular_course_list_second_card_title',
...
export const LandingContactUsSectionDataSlugs = [
  'landing_contact_us_first_card_title',
  'landing_contact_us_first_card_desc',
  'landing_contact_us_second_card_title',
  'landing_contact_us_second_card_desc',
...
export const LandingProgrammeSectionDataSlugs = [
  'landing_most_popular_programme_first_card_title',
  'landing_most_popular_programme_first_card_img',
  'landing_most_popular_programme_first_card_desc',
  'landing_most_popular_programme_second_card_title',
  'landing_most_popular_programme_second_card_desc',
  'landing_most_popular_programme_third_card_title',
  'landing_most_popular_programme_third_card_desc'
];
