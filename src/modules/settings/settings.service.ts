...
import {
  ...
  LandingAboutUsSrtstSectionDataSlugs,
  LandingBenefitSrtstSectionDataSlugs,
  LandingSyllabusSrtstSectionDataSlugs,
  LandingSuccessSrtstSectionDataSlugs,
  LandingChooseUsSectionDataSlugs,
  LandingAchivementSectionDataSlugs,
  LandingMostPopularCourseSectionDataSlugs,
  LandingContactUsSectionDataSlugs,
  LandingProgrammeSectionDataSlugs,
  LandingHowItWorkSectionDataSlugs,
  LandingMainBannerDataSlugs,
  LandingSRTSTPageSlugs,
  LandingPageSlugs,
  SMTPSettingsSlugs,
  TermsPrivacySlugs,
...
export class SettingsService {
  ...
  async updateLandingSrtstMainBannerData(payload: any) {
    try {
      const landing_main_banner_image_url =
        payload.landing_main_banner_image_url
          ? await fetchMyUploadFilePathById(
      ...
      const data = await getAdminSettingsData(LandingSRTSTPageSlugs);

      return successResponse(
        'Landing srtst page main banner section data is updated successfully!',
        data,
      );
    } catch (error) {
      processException(error);
  ...
  async updateLandingSrtstAboutSectionData(
    payload: any,
  ) {
    try {
      const keyValuePairs = Object.entries(payload).map(([key, value]) => {
        // if (key === 'landing_about_us_srtst_image_url') {
        //   value = landing_about_us_srtst_image_url;
        // }
        return { key, value };
      });
      ...
      const data = await getAdminSettingsData(LandingAboutUsSrtstSectionDataSlugs);

      return successResponse(
        'Landing page srtst about us section data is updated successfully!',
        data,
      );
    } catch (error) {
      processException(error);
  ...
  async updateLandingSrtstBenefitSectionData(
    payload: any,
  ) {
    try {
      const keyValuePairs = Object.entries(payload).map(([key, value]) => {
      ...
      const data = await getAdminSettingsData(LandingBenefitSrtstSectionDataSlugs);

      return successResponse(
        'Landing page srtst benefit section data is updated successfully!',
        data,
      );
    } catch (error) {
      processException(error);
  ...
  async updateLandingSrtstSyllabusSectionData(
    payload: any,
  ) {
    try {
      const keyValuePairs = Object.entries(payload).map(([key, value]) => {
      ...
      const data = await getAdminSettingsData(LandingSyllabusSrtstSectionDataSlugs);
      return successResponse(
        'Landing page srtst syllabus section data is updated successfully!',
        data,
      );
    } catch (error) {
      processException(error);
  ...
  async getLandingSrtstAboutSectionData() {
    try {
      const data: any = await getAdminSettingsData(
        LandingAboutUsSrtstSectionDataSlugs,
      );
      return successResponse('Landing page srtst about us section data', data);
    } catch (error) {
      processException(error);
    }
  }

  async getLandingSrtstBenefitSectionData() {
    try {
      const data: any = await getAdminSettingsData(
        LandingBenefitSrtstSectionDataSlugs,
      );
      return successResponse('Landing page srtst benefit section data', data);
    } catch (error) {
      processException(error);
    }
  }

  async getLandingSrtstSyllabusSectionData() {
    try {
      const data: any = await getAdminSettingsData(
        LandingSyllabusSrtstSectionDataSlugs,
      );
      return successResponse('Landing page srtst syllabus section data', data);
    } catch (error) {
      processException(error);
    }
  }

  async getLandingSrtstSuccessSectionData() {
    try {
      const data: any = await getAdminSettingsData(
        LandingSuccessSrtstSectionDataSlugs,
      );
      return successResponse('Landing page srtst success section data', data);
    } catch (error) {
      processException(error);
    }
  }
  ...
  async updateLandingAchievementSectionData(
    payload: any,
  ) {
    try {
      ...
      const data = await getAdminSettingsData(LandingAchivementSectionDataSlugs);

      return successResponse(
        'Landing page achievement section data is updated successfully!',
        data,
      );
    } catch (error) {
      processException(error);
  ...
  async updateLandingProgrammeSectionData(
    payload: any,
  ) {
    try {
      ...
      const data = await getAdminSettingsData(LandingProgrammeSectionDataSlugs);

      return successResponse(
        'Landing Programme section data is updated successfully!',
        data,
      );
    } catch (error) {
      processException(error);
  ...
  async updateContactUsSectionData(
    payload: any,
  ) {
    try {
      const keyValuePairs = Object.entries(payload).map(([key, value]) => {
      ...
      const data = await getAdminSettingsData(LandingContactUsSectionDataSlugs);
      return successResponse(
        'Landing Contact Us section data is updated successfully!',
        data,
      );
    } catch (error) {
      processException(error);
  ...
  async updateLandingMostPopularCourseSectionData(
    payload: any,
  ) {
    try {
      ...
      const data = await getAdminSettingsData(LandingMostPopularCourseSectionDataSlugs);

      return successResponse(
        'Landing page Most Popular Course section data is updated successfully!',
        data,
      );
    } catch (error) {
      processException(error);
  ...
  async getLandingAchievementSectionData() {
    try {
      const data: any = await getAdminSettingsData(LandingAchivementSectionDataSlugs);
      return successResponse('Landing page choose us section data', data);
    } catch (error) {
      processException(error);
    }
  ...
  async getLandingMostPopularCourseSectionData() {
    try {
      const data: any = await getAdminSettingsData(LandingMostPopularCourseSectionDataSlugs);
      return successResponse('Landing most popular couse page section data', data);
    } catch (error) {
      processException(error);
    }
  }

  async getLandingProgrammeSectionData() {
    try {
      const data: any = await getAdminSettingsData(LandingProgrammeSectionDataSlugs);
      return successResponse('Landing programme page section data', data);
    } catch (error) {
      processException(error);
    }
  }
  ...
  async getLandingContactUsSectionData() {
    try {
      const data: any = await getAdminSettingsData(LandingContactUsSectionDataSlugs);
      return successResponse('Landing contact us page section data', data);
    } catch (error) {
      processException(error);
    }
  }
