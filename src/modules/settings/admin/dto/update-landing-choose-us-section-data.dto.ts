...
export class UpdateLandingChooseUsSectionDataDto {
  ...
  @IsOptional()
  @IsString()
  landing_choose_us_list_first_title_user: string;
  ...
  @IsOptional()
  @IsString()
  landing_choose_us_list_second_title_user: string;
  ...
  @IsOptional()
  @IsString()
  landing_choose_us_list_third_title_user: string;
  ...
  @IsOptional()
  @IsString()
  landing_choose_us_list_fourth_title_user: string;
